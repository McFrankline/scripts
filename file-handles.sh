...
# then
#   which brew &> /dev/null || echo "please install brew: https://brew.sh" &&
    #   exit 1
...
#       echo "$combinations" | xargs -P10 -I{} sh -c "curl -sfI
#       https://github.com/{} > /dev/null || echo {}" > github.txt
#
#       echo "available on Github: $(wc -l github.txt)"
#
#
#       # Do the same thing for twitter.com
#       cat github.txt | xargs -P10 -I{} sh -c "curl -sfI
#       https://twitter.com/{} > /dev/null || echo {}" > github-twitter.txt
#
